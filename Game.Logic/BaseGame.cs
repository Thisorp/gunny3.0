...
namespace Game.Logic
{
    public class  BaseGame : AbstractGame
    {
        ...
        internal void SendCreateGame()
        {
            ...
            pkg.WriteInt((int)(byte)m_roomType);
            pkg.WriteInt((int)(byte)m_gameType);
        ...
        internal void SendUseSecondWeapon(Player player, int ResCount)
        {
