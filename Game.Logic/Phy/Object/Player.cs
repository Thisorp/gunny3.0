...
namespace Game.Logic.Phy.Object
{
    public class Player : TurnedLiving
    {
            ...
            : base(id, game, team, "", "", 1000, 0, 1)                   //TODO   lastPatemer    direction
        {
            ...
            SecondWeapon = m_player.SecondWeapon;
            if (this.SecondWeapon != null)
            {
                this.SecondWeaponCount = this.SecondWeapon.StrengthenLevel + 1;
            }
            else
            {
                this.SecondWeaponCount = 1;
            }
            if (m_weapon != null)
            {
        ...
        public override void Reset()
        {
            ...
            {
                SecondWeaponCount = SecondWeapon.StrengthenLevel + 1;
            }
            //m_mainBallId = m_weapon.Property1;
            //m_spBallId = m_weapon.Property2;
            var ballConfig = BallConfigMgr.FindBall(m_weapon.TemplateID);
        ...
        public void InitBuffer(List<int> equipedEffect)
        {
            for (int i = 0; i < equipedEffect.Count; i++)
            {

                ItemTemplateInfo item = ItemMgr.FindItemTemplate(equipedEffect[i]);
        ...
        public int LevelPlusBlood
        {
            ...
            {
                int plusblood = 0;
                if (PlayerDetail.PlayerCharacter.Grade == 11)
                {
                    plusblood = 30;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 12)
                {
                    plusblood = 60;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 13)
                {
                    plusblood = 90;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 14)
                {
                    plusblood = 120;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 15)
                {
                    plusblood = 150;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 16)
                {
                    plusblood = 220;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 17)
                {
                    plusblood = 290;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 18)
                {
                    plusblood = 360;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 19)
                {
                    plusblood = 430;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 20)
                {
                    plusblood = 500;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 21)
                {
                    plusblood = 620;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 22)
                {
                    plusblood = 740;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 23)
                {
                    plusblood = 860;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 24)
                {
                    plusblood = 980;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 25)
                {
                    plusblood = 1100;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 26)
                {
                    plusblood = 1130;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 27)
                {
                    plusblood = 1160;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 28)
                {
                    plusblood = 1190;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 29)
                {
                    plusblood = 1220;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 30)
                {
                    plusblood = 1250;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 31)
                {
                    plusblood = 1370;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 32)
                {
                    plusblood = 1490;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 33)
                {
                    plusblood = 1610;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 34)
                {
                    plusblood = 1730;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 35)
                {
                    plusblood = 1850;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 36)
                {
                    plusblood = 1920;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 37)
                {
                    plusblood = 1990;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 38)
                {
                    plusblood = 2060;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 39)
                {
                    plusblood = 2130;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 40)
                {
                    plusblood = 2200;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 41)
                {
                    plusblood = 2200;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 42)
                {
                    plusblood = 2200;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 43)
                {
                    plusblood = 2200;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 44)
                {
                    plusblood = 2200;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 45)
                {
                    plusblood = 2200;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 46)
                {
                    plusblood = 2200;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 47)
                {
                    plusblood = 2200;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 48)
                {
                    plusblood = 2200;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 49)
                {
                    plusblood = 2200;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 50)
                {
                    plusblood = 2200;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 51)
                {
                    plusblood = 2180;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 52)
                {
                    plusblood = 2160;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 53)
                {
                    plusblood = 2140;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 54)
                {
                    plusblood = 2120;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 55)
                {
                    plusblood = 2100;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 56)
                {
                    plusblood = 2080;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 57)
                {
                    plusblood = 2060;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 58)
                {
                    plusblood = 2040;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 59)
                {
                    plusblood = 2020;
                }
                if (PlayerDetail.PlayerCharacter.Grade == 60)
                {
                    plusblood = 2000;
                }
                return plusblood;
        ...
        {            
            if (this.CanUseItem(this.SecondWeapon.Template))
            {
                if (this.SecondWeapon.Template.Property3 == 31)
                {
                    int count = this.SecondWeapon.Template.Property7 + (int)Math.Pow(1.1, (double)this.SecondWeapon.StrengthenLevel);
                    new AddGuardEquipEffect(count, 2).Start(this);
                }
                else
                {
                    this.SetCurrentWeapon(this.SecondWeapon.Template);
                }
                this.m_energy -= this.SecondWeapon.Template.Property4;
                this.m_delay += this.SecondWeapon.Template.Property5;
                this.m_game.SendPlayerUseProp(this, -2, -2, this.m_weapon.TemplateID);
                if (this.SecondWeaponCount > 0)
                {
                    this.SecondWeaponCount--;
                    this.m_game.SendUseSecondWeapon(this, this.SecondWeaponCount);
                }
            } 
        }
